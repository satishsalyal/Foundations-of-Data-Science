...
A nominal scale usually deals with non-numeric variables or numbers that do not have any value.
...
- The interval scale is the **preferred scale in Statistics** as it helps to assign numerical values to arbitrary assessments such as feelings, calendar types, etc.  
...
It is a type of variable measurement scale that allows researchers to compare the differences or intervals.  
...
| Scale Type | Nature | Quantitative/Qualitative | Zero Point | Example |
|-------------|--------|---------------------------|-------------|----------|
| Nominal | Labeling | Qualitative | No | Gender (M/F) |
| Ordinal | Ranking | Qualitative | No | Survey Ratings |
| Interval | Difference | Quantitative | Arbitrary | Likert Scale |
| Ratio | Absolute Comparison | Quantitative | Yes | Weight (Kg) |

---

> 🧠 **Tip:**  
> Understanding measurement scales is fundamental for selecting the right **statistical techniques** and **data visualization** methods in data analysis.
